...
const VALID_CATS: CatSlug[] = ["publicidad", "entretenimiento", "vxf"];
...
const CATEGORIES: { value: CatSlug; label: string; hint?: string }[] = [
  ...
  { value: "vxf", label: "VXF", hint: "Contenido y entregables VXF." },
];

// Por ahora SIN subcategorías (se mantiene)
...
/* ====================== NUEVOS CAMPOS (reemplaza ficha anterior) ====================== */
type UploadMeta = {
  // 👇 NUEVO: título (manual)
  titulo?: string;
  ...
  // selects
  oficina?: "Chile" | "Mexico" | ""; // 1 opción
  // Tipo: multi-select (una o varias)
  tipo?: string[]; // e.g. ["Color","3D"]
...
export default function DropUploader({
  ...
  // ===== Metadata (reemplaza ficha técnica anterior) =====
  ...
  const handleSelect = (f: File) => {
    ...
    // 👇 auto-sugerir título si está vacío (sin obligar)
    setMeta((prev) => {
  ...
  // Si quieres que sea obligatorio, deja esto:
  ...
  const upload = async () => {
    ...
    try {
      ...
      // Mantengo el nombre "ficha" para NO tocar el backend por ahora
...
//     value: "publicidad",
//     label: "Publicidad",
//     hint: "Piezas y campañas publicitarias.",
//   },
//   {
//     value: "entretenimiento",
//     label: "Entretenimiento",
//     hint: "Contenido y piezas de entretenimiento.",
//   },
//   {
//     value: "vxf",
//     label: "VXF",
//     hint: "Contenido y entregables VXF.",
//   },
// ];
