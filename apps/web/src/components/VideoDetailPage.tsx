...
const MAX_CAPTION_POLL_ATTEMPTS = 120;

const checkCaptions = async () => {
  attempts += 1;

  if (attempts > MAX_CAPTION_POLL_ATTEMPTS) {
    if (intervalId) {
      clearInterval(intervalId);
      intervalId = null;
    }

    console.warn("CLOUDFLARE_CAPTIONS_POLLING_STOPPED", {
      uploadId: id,
      attempts: MAX_CAPTION_POLL_ATTEMPTS,
    });
