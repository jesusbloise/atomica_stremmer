  ...
  return (
    <div className="sticky top-0 z-40 bg-zinc-950/90 backdrop-blur border-b border-zinc-800 px-4 py-2 flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          className="px-3 py-1 border border-red-600 text-red-500 rounded hover:bg-red-600/10"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
          <div className="w-full max-w-md bg-zinc-900 border border-zinc-700 rounded-lg p-4">
            ...
            <div className="flex justify-end gap-2">
              <button className="px-3 py-1 rounded border border-zinc-600" onClick={() => setConfirmOpen(false)} disabled={isPending}>
                Cancelar
              </button>
              <button className="px-3 py-1 rounded border border-red-600 text-red-500 hover:bg-red-600/10" onClick={doBulkDelete} disabled={isPending}>
